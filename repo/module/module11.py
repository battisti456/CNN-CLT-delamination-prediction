...
class Module11_Stack_Sequence(nn.Sequential):
    def __init__(
                self,
                k:int,
                num_layers:int,
...
class Module11_Stack(nn.Module):
    def __init__(
            self,
            k:int,
            num_layers:int,
        ...
        self._stride = stride
        super().__init__()
        self.sequence = Module11_Stack_Sequence(k,num_layers,in_depth,out_depth,stride)
        self.gate = nn.Conv1d(in_depth,in_depth,1,stride=stride,bias=False)
...
class Module11(nn.Sequential):
    #fewer step downs than module 3
    def __init__(self,hp:Hyperparameters):
        super().__init__()
        n= 2
        _layers = [
            Module11_Stack(5,n,1,5,1),
            Module11_Stack(5,n,5,10,2),
            Module11_Stack(5,n,10,15,2),
            Module11_Stack(5,n,15,20,2),
            Module11_Stack(5,n,20,25,2),
            Module11_Stack(5,n,25,30,2),
